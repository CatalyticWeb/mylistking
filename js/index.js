...
/*#################################################
There was a missing void parentheses set after the 
final updateCount function call below. - GCH
#################################################*/
...
list to search for duplicate items. -GCH
###########################################*/
...
/*###############################################
See above code to find the changes made to create
new list items with the favorite class. -GCH
################################################*/
...
a for loop and if...else statement to to check
for duplicates and blanks. In the case of either
a window alert (I'm sorry) pops up to let the
user known they have entered an invalid list
item, and clears the input field. -GCH
################################################*/
